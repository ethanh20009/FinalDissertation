...
def save_layer(root, defs, width, height, shapes, shape_groups, use_gamma=False):
...
def save_svg_composed(filename, width, height, layers, use_gamma=False):
    ...
    for shapes, shape_groups in layers:
        save_layer(root, defs, width, height, shapes, shape_groups, use_gamma)
